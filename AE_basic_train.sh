...
new_epoch=200
sed -i "s#epoch:.*#epoch: $new_epoch#" config/AE_basic/config.yaml

#第一次

new_test_data_path="'data/penism/test_data1.csv'"
sed -i "s#test_data_path:.*#test_data_path: $new_test_data_path#" config/AE_basic/config.yaml

python main.py --model_config_path config/AE_basic/config.yaml
