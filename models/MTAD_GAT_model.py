...
class MTAD_GAT(nn.Module):
    ...
    def __init__(self,config,feat_gat_embed_dim=None,time_gat_embed_dim=None,):
        ...
        forecast_n_layers = config['forecast_n_layers']
        forecast_hid_dim = config['forecast_hid_dim']
